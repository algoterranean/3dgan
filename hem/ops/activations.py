...
def value_fraction(x, value, name=None):
    with ops.name_scope(name, "zero_fraction", [x]):
        x = ops.convert_to_tensor(x, name="tensor")
        value = constant_op.constant(value, dtype=x.dtype, name="value")
